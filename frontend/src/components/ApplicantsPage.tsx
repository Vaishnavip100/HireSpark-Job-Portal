...
const NetworkingPage: React.FC<NetworkingPageProps> = ({ userInfo, onNavigate }) => {
  ...
  if (isFetching) {
    return <div className="text-center py-20">Loading Community Feed...</div>;
  }
          ...
          <form onSubmit={handlePostSubmit}>
            ...
            <div className="flex justify-end items-center mt-2">
              ...
              <button 
                ...
                className="bg-blue-600 text-white font-semibold px-6 py-2 rounded-lg flex items-center disabled:bg-gray-400 hover:bg-blue-700 transition-colors"
              >
                {isPosting 
      ...
      <div className="space-y-6">
        {posts.length === 0 ? (
          ...
          posts.map(post => {
            ...
            const authorInitial = post.author ? post.author.name.charAt(0) : '?';
